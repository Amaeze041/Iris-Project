# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 09:10:44 2023
...
Base model is used to declare the format of input data. Eg integer, float etc.
'''
...
#load the model
Iris_model=pickle.load(open("C:/Users/CLAIRE/Documents/Iris FastAPI/Python codes/iris_classification_model.sav",'rb'))
